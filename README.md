...
The joke is generated by `gpt-5.4-mini`; it is not stored in the repository.
...
(Hello World and GLaDOS) and `gpt-5.6-sol` (Gilfoyle and Solid Snake). They do
not read `CACOPHONY_AZURE_DEPLOYMENT`.
     ...
     correctness:
       ...
       steps:
         ...
         - name: Run correctness review
           id: review
           uses: jdylanmc/cacophony@84f8b820ca4e4c068a872c31f92844f74e873221
           with:
